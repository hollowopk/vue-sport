<template>
  <div class="leftnav">
   ...
   <div class="nav">
      <el-menu  mode="horizontal" :default-active="activeIndex"  class="el-menu-demo">
      <template v-for="item in navLists">
        <el-menu-item :key="item.navID">
...
export default {
  name:"leftnav",
    ...
    searchSport(){
     if(this.content){
        this.$router.push({name:'sportsEquipment',query:{name:this.content}});
     }else{
       //查询所有运动
